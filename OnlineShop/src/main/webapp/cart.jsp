		...
		<div class="row">
			<c:forEach items="${rs2.rows}" var="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
					...
					<h5>Total Price : ${row.price*cartdetails.quantity } </h5> 
					
					Quantity<input type="text" name="qty" value="${cartdetails.quantity}" /> 
					<input type="submit" value="Update Cart" class="btn btn-success btn-block" />
